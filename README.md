...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://echo-rest-api/blob/master/LICENSE)
[![Go Reference](https://pkg.go.dev/badge/echo-rest-api.svg)](https://pkg.go.dev/echo-rest-api)
[![GoReportCard Badge](https://goreportcard.com/badge/echo-rest-api)](https://goreportcard.com/report/echo-rest-api)
...
> **DO NOT FORK** this is meant to be used from **[Use this template](https://echo-rest-api/generate)** feature.

1. Click on **[Use this template](https://echo-rest-api/generate)**
